...
class Ui_SocioPage(object):
    ...
    def retranslateUi(self, SocioPage):
        ...
        self.label_2.setText(QCoreApplication.translate("SocioPage", u"1 Apellido", None))
        self.label_3.setText(QCoreApplication.translate("SocioPage", u"2 Apellido", None))
