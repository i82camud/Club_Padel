...
class Ui_PistaPage(object):
    ...
    def retranslateUi(self, PistaPage):
        ...
        self.btn_listar.setText(QCoreApplication.translate("PistaPage", u"Listar Pistas", None))
        self.btn_listar_reservas.setText(QCoreApplication.translate("PistaPage", u"Listar Reservas", None))
